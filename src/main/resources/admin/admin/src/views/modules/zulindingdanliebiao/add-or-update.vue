          ...
          <el-form-item class="input" label="租赁天数" prop="zulintianshu">
              <el-input v-model="ruleForm.zulintianshu" 
                placeholder="租赁天数" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="提车日期" prop="ticheriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.ticheriqi" 
                type="date"
                placeholder="提车日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ticheriqi" label="提车日期" prop="ticheriqi">
              <el-input v-model="ruleForm.ticheriqi" 
                placeholder="提车日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实付金额" prop="shifujine">
            <el-input v-model="shifujine"
                placeholder="实付金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shifujine" label="实付金额" prop="shifujine">
              <el-input v-model="ruleForm.shifujine" 
                placeholder="实付金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
                                                                                                                                                shifujine:{
                                                                                                                                                                                                                                              get: function () {
        return 1*this.ruleForm.zulinjiage*this.ruleForm.zulintianshu
      }
    },
                                                  },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zulintianshu = true;
            continue;
	            	            ...
	            	            if(o=='ticheriqi'){
            this.ruleForm.ticheriqi = obj[o];
	    this.ro.ticheriqi = true;
            continue;
          }
	            	            if(o=='shifujine'){
            this.ruleForm.shifujine = obj[o];
	    this.ro.shifujine = true;
            continue;
          }
	            	            	            	                    }
                                                                                                                                                                                                                                                              }
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                ...
                                                                                                                                // 多级联动参数
                                                                                                                                                                  info(id) {
      this.$http({
        url: `zulindingdanliebiao/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
                  // ${column.compare}
                              ...
                              // ${column.compare}
                              // ${column.compare}
              this.ruleForm.shifujine = this.shifujine
                              // ${column.compare}
                              // ${column.compare}
                              // ${column.compare}
        ...
        if (valid) {
          this.$http({
            url: `zulindingdanliebiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zulindingdanliebiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
